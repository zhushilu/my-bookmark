            ...
            .then((bookmarks) => {
                if (bookmarks.length == 1) {
                    ...
                    if (!/http(s)?:\/\/([\w-]+\.)+[\w-]+(\/[\w- .\/?%&=]*)?/.test(url)) {
                        ...
                        var faviconUrl = "https://favicon.zhusl.com/?url=" + url2; // 默认地址
                        if (faviconState == 1) {
                            faviconUrl = "https://favicon.zhusl.com/?url=" + url2;
                        } else if (faviconState == 2) {
                            faviconUrl = "http://www.google.com/s2/favicons?domain=" + url2;

                       // var faviconUrl = "https://favicon.zhusl.com/?url=" + url; // 默认地址
                       // if (faviconState == 1) {
                       //     faviconUrl = "https://favicon.zhusl.com/?url=" + url;
                       // } else if (faviconState == 2) {
